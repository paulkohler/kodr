...
The retry also failed, but this time the run left inspectable evidence at `.koder/runs/2026-05-26T09-23-40.825Z`. With the harness gap closed, the example was completed manually so the repo still gains the fixture.
